...
<head>
<meta charset="UTF-8">
<title>Pics Store | User's Images</title>
...
%>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbar-001">
			...
			<ul class="nav navbar-nav nav_menu">
				...
				<li><a href="#" class="navbar-brand" id="this_page"> <%= pageUser.getUsername() %>的图片 </a></li>
			</ul>
	...
	<section id="pageup">
		<div class="panel panel-default">
			<div class="panel-heading"><span class="glyphicon glyphicon-picture"> </span>  <%= pageUser.getUsername() %>上传的图片</div>
				...
				<div class="row">
	               <input type="text" id="pageuser_uid" value="<%= pageUser.getUserID() %>" disabled style="display:none">
					...
					<!-- 页码 -->
                            ...
                            String currentPath = "./userpics.pers?"+paramStr;
